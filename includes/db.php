...
class db
{
	...
	public function getConfig(){
		return array($this->host, $this->username, $this->password, $this->db);
	}
     ...
     * @param int $port
     */
    public function __construct($limbo = false, $cnnc = [])
    {
		if(sizeof($cnnc) == 0){
			$host = 'localhost';
			$username = 'root';
    ...
    */
    ...
    {
        return new db (Array('host' => $subQueryAlias, 'isSubQuery' => true));
    }

    /**
     * Method returns a copy of a db subquery object
     *
     * @param object new db object
     */
